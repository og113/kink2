...
if [ -z "$1" ]
  then
	...
	cd ../mpi
	matlab -nodisplay -r "[D1,D2,diff,maximum] = compareDDS;[V,D] = eigs(D2,2,-20);V0 = V(:,1);printVector(V0,'../kink2/data/stable/eigVec_pot_3_L_$1.dat');quit"
	echo "negative eigenvector printed to data/stable/eigVec_pot_3_L_$1.dat"
	echo ""
	cd ../kink2
fi
